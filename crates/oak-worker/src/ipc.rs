...
//! shared-memory frame-slot transport, owned by the oak-worker binary
//! since M14 R2 (the facade keeps its own copy for the frozen
//! `oakengine_ipc_*` C ABI). The transport is the Rust port of
