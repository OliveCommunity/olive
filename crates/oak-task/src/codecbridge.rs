...
//!
//! Wires oakcodec's task-submit callback (`oak_codec::task::set_task_submit_cb`)
...
use oak_codec::error::Error as CodecError;
...
fn proxy_params_from_codec(params: &oak_codec::proxymanager::ProxyParams) -> ProxyParams {
	ProxyParams {
		width: params.width,
