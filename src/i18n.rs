...
const EN: &[(&str, &str)] = &[
	...
	("timeline.snap", "Snap"),
	("timeline.add_video_track", "Add Video Track"),
	("timeline.add_audio_track", "Add Audio Track"),
	// --- project bin ---
	("bin.footage", "Footage"),
	("bin.music", "Music"),
	...
	("timeline.context.add_video_track", "Add Video Track"),
	("timeline.context.add_audio_track", "Add Audio Track"),
...
const ZH: &[(&str, &str)] = &[
	...
	("timeline.snap", "吸附"),
	("timeline.add_video_track", "新建视频轨"),
	("timeline.add_audio_track", "新建音频轨"),
	// --- project bin ---
	("bin.footage", "素材"),
	("bin.music", "音乐"),
	// --- history (real undo stack) ---
	...
	("timeline.context.add_video_track", "新建视频轨"),
	("timeline.context.add_audio_track", "新建音频轨"),
