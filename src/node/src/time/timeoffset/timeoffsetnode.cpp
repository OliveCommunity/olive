...
const std::string TimeOffsetNode::k_time_input = "time_in";
const std::string TimeOffsetNode::k_input_input = "input_in";
...
TimeRange TimeOffsetNode::input_time_adjustment(const std::string &input, int element,
...
TimeRange
TimeOffsetNode::output_time_adjustment(const std::string &input, int element,
