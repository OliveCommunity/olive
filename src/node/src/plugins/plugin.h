...
namespace plugin
{
const std::string k_texture_input = "tex_in";
...
public:
	...
	std::vector<CategoryID> category() const override;
	std::string sub_category() const override;
...
public:
	void push_button_clicked(std::string name);
};
