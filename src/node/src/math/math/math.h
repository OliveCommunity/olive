...
public:
	...
	{
		return static_cast<Operation>(get_standard_value(k_method_in).to_int());
	}
	...
	static const std::string k_method_in;
	static const std::string k_param_a_in;
	static const std::string k_param_b_in;
	static const std::string k_param_c_in;
};
