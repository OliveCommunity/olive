...
ProjectSerializer211228::load(Project *project, XmlStreamReader *reader,
...
void ProjectSerializer211228::load_color_manager(XmlStreamReader *reader,
...
void ProjectSerializer211228::load_project_settings(XmlStreamReader *reader,
												  Project *project) const
{
	while (xml_read_next_start_element(reader)) {
		if (reader->name() == "input") {
...
void ProjectSerializer211228::load_input(Node *node, XmlStreamReader *reader,
...
void ProjectSerializer211228::load_immediate(XmlStreamReader *reader,
											Node *node,
...
bool ProjectSerializer211228::load_position(XmlStreamReader *reader,
										   uintptr_t *node_ptr,
...
void ProjectSerializer211228::load_node_custom(XmlStreamReader *reader,
											 Node *node,
											 XMLNodeData &xml_node_data) const
{
	// Viewer-based nodes
...
void ProjectSerializer211228::load_timeline_points(XmlStreamReader *reader,
...
void ProjectSerializer211228::load_work_area(XmlStreamReader *reader,
...
void ProjectSerializer211228::load_marker_list(XmlStreamReader *reader,
