...
> For the Chinese version, see [`docs/zh/preview-optimization.md`](./zh/preview-optimization.md).

---

This document records optimization opportunities for Oak Video Editor's preview system, sorted by priority.
